...
public enum CustomValidationStatus {
    ...
    NOT_CONSTRUCT_CLASS("생성자를 생성할 수 없는 클래스입니다.", HttpStatus.OK.LOCKED),
    ...
    NO_SHAED_SPACE("해당 사업자는 어떠한 공유 공간도 입력하시지 않았습니다.", HttpStatus.NOT_FOUND),
    EXIST_USER("해당 이메일은 이미 사용중 입니다.", HttpStatus.CONFLICT),
    CHECK_AGAIN("아이디나 비밀먼호를 확인해 주세요", HttpStatus.BAD_REQUEST),
