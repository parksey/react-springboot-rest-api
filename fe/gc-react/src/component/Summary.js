...
function Summary({items =[], onOrderSubmit}) {
    ...
    const changePostInput = (e) => setOrder({...order, postcode: e.target.value});
        ...
        <div className="col-md-4 summary p-4">
            ...
            <form>
                ...
                <div className="mb-3">
                    ...
                    <input type="text" className="form-control" value={order.postcode} onChange={changePostInput} id="postcode" />
                </div>
